...
ScrollTrigger.addEventListener("scrollEnd", () =>
  scrubTo(snap((iteration + trigger.progress) * seamlessLoop.duration()))
);
document.addEventListener(
  "wheel",
  () => trigger.progress < 1e-4 && !trigger.wrapping && wrapBackward(trigger)
);

function wrapForward(trigger, progress) {
...
function wrapBackward(trigger, progress) {
